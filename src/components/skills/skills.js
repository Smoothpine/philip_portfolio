...
const skills = () => {
	return(
		<div className="w-100 pt5" style={{backgroundColor: "#32A0A6", color: "#f7f9fb", fontFamily: 'Helvetica, system sans-serif', paddingBottom: "2.4rem"}}>
			...
			<h1 className="f4 mt3 mb0 tc pv3 ph5 fw4" style={{fontFamily: 'Helvetica, system sans-serif'}}>Server & Databases</h1>
			<div className="flex justify-center mt3">
			...
			<h1 className="f4 mt3 mb0 tc pv3 ph5 fw4" style={{fontFamily: 'Helvetica, system sans-serif'}}>Deployment</h1>
			<div className="flex justify-center mt3">
			  <div className="mw-20 w-20 w-10-l pa3 mh1">
			...
			<h1 className="f4 mt3 mb0 tc pv3 ph5 fw4" style={{fontFamily: 'Helvetica, system sans-serif'}}>Version Control</h1>
			<div className="flex justify-center mt3">
			  <div className="mw-20 w-20 w-10-l pa3 mh1">
