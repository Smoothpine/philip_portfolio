		...
		<div className="w-90 center">
			...
			<div className="flex flex-wrap mt5">
				<div className="w-100 hidden bt b--black-10" >
		  		...
		  		<div className="pa3">
		  			<p className="tc f6 f5-ns lh-copy measure mv1 flex-end center fw5" style={{fontFamily: 'Helvetica, system serif'}}>
		  					<a className="f6 link dim ba bw1 ttu ph3 pv2 mb2 dib mr1 w-50 w-40-l" style={{color: "#5085a5", borderColor: "#5085a5"}} href="https://photogenic-app.herokuapp.com/" target="_blank" rel="noopener noreferrer">Go to Project</a>
		  					<a className="f6 link dim ba bw1 ttu ph3 pv2 mb2 dib mr1 w-50 w-40-l" style={{color: "#5085a5", borderColor: "#5085a5"}} href="https://github.com/Smoothpine/Photogenic-app" target="_blank" rel="noopener noreferrer">Source Code</a>
		  			</p>
		  		</div>
				</div>
				<div className="w-100 hidden bt b--black-10">
		  		...
		  		<div className="pa3">
		  			<p className="tc f6 f5-ns lh-copy measure mv1 flex-end center fw5" style={{fontFamily: 'Helvetica, system serif'}}>
		  					<a className="f6 link dim ba bw1 ttu ph3 pv2 mb2 dib mr1 w-50 w-40-l" style={{color: "#5085a5", borderColor: "#5085a5"}} href="https://mighty-shore-29205.herokuapp.com/" target="_blank" rel="noopener noreferrer">Go to Project</a>
		  					<a className="f6 link dim ba bw1 ttu ph3 pv2 mb2 dib mr1 w-50 w-40-l" style={{color: "#5085a5", borderColor: "#5085a5"}} href="https://github.com/Smoothpine/Yelp-Camp" target="_blank" rel="noopener noreferrer">Source Code</a>
		  			</p>
		  		</div>
				</div>
				<div className="w-100 hidden bt b--black-10 pb5">
		  		...
		  		<div className="pa3">
		  			<p className="tc f6 f5-ns lh-copy measure mv1 flex-end center fw5" style={{fontFamily: 'Helvetica, system serif'}}>
		  					<a className="f6 link dim ba bw1 ttu ph3 pv2 mb2 dib mr1 w-50 w-40-l" style={{color: "#5085a5", borderColor: "#5085a5"}} href="http://young-sands-95084.herokuapp.com/" target="_blank" rel="noopener noreferrer">Go to Project</a>
		  					<a className="f6 link dim ba bw1 ttu ph3 pv2 mb2 dib mr1 w-50 w-40-l" style={{color: "#5085a5", borderColor: "#5085a5"}} href="https://github.com/Smoothpine/DevMatch" target="_blank" rel="noopener noreferrer">Source Code</a>
		  			</p>
		  		</div>
				</div>
			</div>
