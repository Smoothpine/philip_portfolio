	...
	return(
		<div className="w-100 pt5 pb2" style={{backgroundColor: "#f7f9fb", color: "#3262A6"}}> 
			<div className="w-90 center tc mb5" >
				<h2 className='tc f3 lh-copy ttu fw5 tracked' style={{fontFamily: 'Helvetica, system sans-serif'}}>About Me</h2>
				<p className="mv0 pv3" style={{fontFamily: 'Georgia, system serif', color: "#3262A6", lineHeight: "1.5em"}}>
